...
Provide a clear explanation of the concept and solution."""
    ...
    def evaluate_reasoning(self,question,correct_answer,user_answer,user_reasoning,topic):#topic already in here
        prompt = f"""
        You
        are
        a
        ...
        a
        student
        's reasoning, so NO EXPLANATIONS.
        ...
        Definitions:
        - concept_match = true if reasoning
        reflects
        the
        expected
        concept
        ...
        # this is json formatted -> can be converted to dict?
