...
from models import (
    ...
    SkillLevel, Goal, QuestionScore, TopicPerformance, MasteryStatus
)
...
class TestScoringEngine:
    ...
    def test_calculate_average_score(self):
        ...
        scores = [
            QuestionScore(base=1.0, difficulty_multiplier=1.0, hint_penalty=1.0),
            QuestionScore(base=1.0, difficulty_multiplier=1.0, hint_penalty=0.6),
            QuestionScore(base=0.0, difficulty_multiplier=1.0, hint_penalty=1.0),
        ]
    ...
    def test_calculate_consistency_mixed(self):
        ...
        consistency = scoring_engine.calculate_consistency([True, False, True, False])
